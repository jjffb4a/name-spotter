...
COMP_DIR="app/components/name-spotter"
mkdir -p "$COMP_DIR"

echo "📄 Writing ui-box.ts..."
cat <<EOF > "$COMP_DIR/ui-box.ts"
...
echo "🧩 Writing ui-box.hbs..."
cat <<EOF > "$COMP_DIR/ui-box.hbs"
...
echo "✅ Interactive UI Box component updated!"
